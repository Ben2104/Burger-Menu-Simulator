...
class Order:
    def init(self):
        ...
        deAnza = Burger("De Anza Burger", 5.25)
        baconCheese = Burger("Bacon Cheese", 5.75)
        mushroomSwiss = Burger("Mushroom Swiss", 5.95)
        western = Burger("Western Burger", 5.95)
        donCali = Burger("Don Cali Burger", 5.95)

        self._priceDict = {
                1: (deAnza.getName(), deAnza.getPrice()),
                2: (baconCheese.getName(), baconCheese.getPrice()),
                3: (mushroomSwiss.getName(), mushroomSwiss.getPrice()),
                4: (western.getName(), western.getPrice()),
                5: (donCali.getName(), donCali.getPrice())
        }
